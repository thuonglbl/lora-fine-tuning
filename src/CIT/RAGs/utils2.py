...
def build_graph(
 ...
 "Rephrased question: "
    ...
    def generate(state: MessagesState):
        ...
        recall_guidelines = f"""Remember to cite your sources, especially the URL according to the format I gave you. If you give a document title, give also the URL. And simply say that you don't have the information when you cannot answer. Citing the URL(s) is very important.

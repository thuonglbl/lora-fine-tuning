#to be continued, not useable yet
...
parser.add_argument(
    "--splits_folder",
    type=str,
    default="./src/CIT/training/models/cv/data/22.5",
...
parser.add_argument(
    "--test_answers_folder",
    type=str,
    default="./src/CIT/training/models/cv/data/test_answers/ft_22.5/ft",
    help="where to store answers on the different test sets",
)

parser.add_argument(
    "--scores_folder",
    type=str,
    default="./src/CIT/training/models/cv/scores/ft_22.5/ft",
...
parser.add_argument(
    ...
    type=str,
    default="true",
    help="If True, the answers are already computed and will be used to compute the scores.",
)
...
if __name__ == "__main__":
    ...
    models_name = os.listdir(models_folder)

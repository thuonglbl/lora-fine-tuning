...
python compute_url_precision_recall.py \
    ...
    --answers_path "./src/CIT/evaluation/results/balanced_split/answers/base_sd_urls/base_run2.jsonl" \
    --answers_already_computed "false" \
    --output_path "./src/CIT/evaluation/results/balanced_split/precision_recall/base_sd_urls/base_run2.json" \